...
$q = "select eszktipus, case when aktiveszktipus then 'aktív' else 'zárolt' end as statusz ";
$q .= "from eszktipus $orderby eszktipus;";



$fejlec ='Eszköztípusok listája';
